...
describe('Component Tests', () => {
  describe('ResultadoExame Management Component', () => {
    let comp: ResultadoExameComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ResultadoExameComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.resultadoExames?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
