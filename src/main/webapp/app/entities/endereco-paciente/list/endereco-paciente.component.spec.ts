...
import { EnderecoPacienteComponent } from './endereco-paciente.component';

describe('Component Tests', () => {
  describe('EnderecoPaciente Management Component', () => {
    let comp: EnderecoPacienteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnderecoPacienteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enderecoPacientes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
