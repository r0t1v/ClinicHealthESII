...
describe('Component Tests', () => {
  describe('ContatoPaciente Management Component', () => {
    let comp: ContatoPacienteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ContatoPacienteComponent],
        providers: [
          Router,
          {
        ...
        .overrideTemplate(ContatoPacienteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contatoPacientes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
